...
// Процедура заполняет переданный в параметрах список выбора 
// 
// Параметры: 
...
// Функция получает вид периода по переданным датам начала и окончания периода 
// 
// Параметры: 
//  НачалоПериода - значение даты начала периода
//  КонецПериода - значение даты окончания периода
//  МинимальныйВидПериода - по умолчанию Неопределено, если указано значение, 
//                           то в список будут включены только большие или равные минимальному виду периода
//
// Возвращаемое значение:
//   СписокПериодов - список значений периодов
//
...
// Процедура обеспечивает переключение страниц выбора периода
// 
// Параметры:
//  ВидПериода - вид периода, перечисление
//  Страница - страницы в форме выбора периодов
//  ПараметрыСтраниц - параметры страниц, по умолчанию используется Неопределено
//
// Процедура регулирует переключение между двумя страницами: "Произвольный период" и "Период по видам"
//
...
// Функция подбирает период отчета по виду периода и тексту представления периода
// 
// Параметры: 
//  ВидПериода - вид периода
//  Текст - текст представления периода
//  ДатаНачала - значение даты начала периода
//  ДатаОкончания - значение даты окончания периода
//
// Возвращаемое значение:
//   ДанныеДляВыбора - получает список значений периодов
//
...
// Процедура получает значение периода по виду периода и массиву слов из текста представления периода
// 
// Параметры: 
//  ВидПериода - вид периода
//  МассивСлов - массив слов из текста представления периода
//  ДанныеДляВыбора - значение даты окончания периода
//
// Возвращаемое значение:
//   ДанныеДляВыбора - получает список значений периодов
//
...
// Функция получает месяц из строки представления месяца 
// 
// Параметры: 
//  СтрокаПредставленияМесяца - строка представления месяца
//
// Возвращаемое значение:
//   Месяц - получает строковое представление месяца
//
...
// Функция проверяет, содержит ли строка искомые символы 
// 
// Параметры: 
//  СтрокаНаПроверки - строка для проверки
//  СтрокаСимволов - искомые символы
//
// Возвращаемое значение:
//   СодержатТолькоПодстроку - булево: если содержит, то истина
//
