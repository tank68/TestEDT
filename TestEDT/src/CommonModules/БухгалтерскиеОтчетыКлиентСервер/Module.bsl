// Функция получает параметр вывода компоновщика настроек или настройки СКД
//
// Параметры:
...
//      ЗначениеПараметра - значение параметра компоновщика настроек или настройки СКД
//
...
// Функция устанавливает параметр вывода компоновщика настроек или настройки СКД
//
// Параметры:
//		КомпоновщикНастроекГруппировка - компоновщик настроек или настройка/группировка СКД
//		ИмяПараметра - имя параметра СКД
...
// Функция добавляет отбор в коллекцию отборов компоновщика или группы отборов
//
// Параметры:
...
//
// Возвращаемое значение:
//      НовыйЭлемент - новый элемент отбора
//
...
//
// Возвращаемое значение:
//      ВыбранноеПоле - элемент выбранного поля
//
...
//
// Возвращаемое значение:
//      ЗначениеПараметра - значение параметра компоновки данных
//
...
// Функция получает свойство поля 
//
// Параметры:
//		ЭлементСтруктура - структура настроек доступных полей выбора
//		Поле - переданное поле
//      Свойство      - по умолчанию используется свойство "Заголовок"
//
// Возвращаемое значение:
//      Результат - полученное свойство поля
//
...
// Процедура скрывает настройки при формировании отчета 
//
// Параметры:
//		Форма - форма отчета
//		ДополнительныеПараметры - дополнительные параметры, по умолчанию Неопределено
//
// Процедура скрывает настройки при формировании отчета
//
Процедура СкрыватьНастройкиПриФормированииОтчета(Форма, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СкрыватьНастройкиПриФормированииОтчета Тогда
		...
		Если КнопкаПанельНастроек <> Неопределено Тогда
			КнопкаПанельНастроек.Пометка = ПанельНастроек.Видимость;
		КонецЕсли;
	КонецЕсли;
	
КонецПроцедуры

// Процедура изменяет заголовок кнопки Панель отчетов 
//
// Параметры:
//		Кнопка - 
//		ВидимостьПанелиНастроек - Булево
//
		...
		Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных") И ЭлементОтбора.Использование Тогда
			Если ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Портфель") Тогда
				Если ЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно Тогда 
					ЭлементОтбора.ПравоеЗначение = Отчет.Портфель;
				Иначе
