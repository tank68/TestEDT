...
//	
//	Возврат Справочники.ДУ_ДоговорыКонтрагентов.ПустаяСсылка();
//	
...
//	// Для УП будет
//	//
//	// ВЫРАЗИТЬ(ПолеДоговор КАК Справочник.ДУ_ДоговорыКонтрагентов).ХозяйственнаяОперация
//	
//	ИмяРеквизитаВидДоговора = БухгалтерскийУчетКлиентСерверПереопределяемый.ПолучитьИмяРеквизитаВидДоговора();
//	
//	Возврат СтрЗаменить("ВЫРАЗИТЬ(ПолеДоговор КАК Справочник.ДУ_ДоговорыКонтрагентов)." + ИмяРеквизитаВидДоговора, "ПолеДоговор", ИмяПоля); 
//	
...
//	
//	Возврат СтрЗаменить("ВЫРАЗИТЬ(ПолеДоговор КАК Справочник.ДУ_ДоговорыКонтрагентов).РасчетыВУсловныхЕдиницах", "ПолеДоговор", ИмяПоля);
//	
...
//	Возврат "ВЫРАЗИТЬ(" + ИмяПоля + " КАК Справочник.ДУ_ДоговорыКонтрагентов).УчетАгентскогоНДС";
...
//	Возврат "ВЫРАЗИТЬ(" + ИмяПоля + " КАК Справочник.ДУ_ДоговорыКонтрагентов).ВидАгентскогоДоговора";
...
//	ДоговорКонтрагента = Справочники.ДУ_ДоговорыКонтрагентов.ПустаяСсылка();
...
//	СтруктураРеквизиты.Вставить("Ссылка",  				Справочники.ДУ_ДоговорыКонтрагентов.ПустаяСсылка());
...
////
//// Параметры:
////	ЮрФизЛицо 	- СправочникСсылка.Организации, СправочникСсылка.ДУ_Контрагенты, лицо, 
////					для которого возвращается банковский счет.
////	Валюта 		- СправочникСсылка.Валюты, требуется для единообразия с БРУ и УП
////
//// Возвращаемое значение:
//// 	СправочникСсылка.ДУ_БанковскиеСчета - основной банковский счет.
////
...
//		ИЛИ ТипЗнч(ЮрФизЛицо) = Тип("СправочникСсылка.ДУ_Контрагенты")  Тогда
//		
...
//	|			ТОГДА ЕСТЬNULL(НаименованияОрганизаций.НаименованиеПолное, Организации.НаименованиеПолное)
//	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
...
//	|ИЗ
//	|	Справочник.ДУ_БанковскиеСчета КАК БанковскиеСчета
...
//		Иначе
//			
//			Если ТипЗнч(ЮрФизЛицо) = Тип("СправочникСсылка.ДУ_Контрагенты") Тогда
