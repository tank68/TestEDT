...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Анализ счета ЕПС " + Отчет.Счет + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если ЗначениеЗаполнено(Отчет.Счет) Тогда 
		КоличествоСубконто = БухгалтерскийУчетПовтИсп.ПолучитьСвойстваСчетаЕПС(Отчет.Счет).КоличествоСубконто;
	Иначе
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	ДанныеСчета 				= БухгалтерскийУчетПовтИсп.ПолучитьСвойстваСчетаЕПС(Отчет.Счет);
...
Процедура УправлениеФормой(Форма)
	...
	ДанныеСчета = БухгалтерскийУчетПовтИсп.ПолучитьСвойстваСчетаЕПС(Форма.Отчет.Счет);
...
Процедура ГруппировкаКорСчетПриИзменении(Элемент)
	...
	БухгалтерскиеОтчетыКлиент.ТабличноеПолеПоСчетамСчет_ЕПС_ПриИзменении(ЭтаФорма, "ГруппировкаКор", Элемент);
