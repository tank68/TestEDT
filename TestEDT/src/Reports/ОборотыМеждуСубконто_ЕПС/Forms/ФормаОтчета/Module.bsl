...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Обороты между субконто ЕПС " + ОбщийТекстСубконто + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
...
#Область ПроцедурыОбработчикиСобытийГруппыПериод
...
#Область ПроцедурыОбработчикиСобытийПоляТабличногоДокумента
...
#Область ПроцедурыОбработчикиСобытийГруппыВидыСубконто
...
#Область ПроцедурыОбработчикиСобытийГруппыВидыКорСубконто
...
#Область ПроцедурыОбработчикиСобытийГруппыПоказатели
...
#Область ПроцедурыОбработчикиСобытийГруппыГруппировка
...
#Область ПроцедурыОбработчикиСобытийГруппыОтборы
...
#Область ПроцедурыОбработчикиСобытийГруппыДополнительныеПоля
...
#Область ПроцедурыОбработчикиСобытийГруппыСортировка
...
#Область ПроцедурыОбработчикиСобытийГруппыОформление
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.СписокВидовКорСубконто.ТипЗначения = Новый ОписаниеТипов("ПланВидовХарактеристикСсылка.ВидыСубконтоЕПС");
