...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	эОтбор.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("УправляющаяКомпания");
	...
	ОткрытьФорму("Справочник.Портфели.ФормаСписка",ПараметрыФормы,Источник,Уникальность,ПараметрыВыполненияКоманды.Окно); 	
